...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="MULTICAN_CONFIG" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0" description="Configures MultiCAN peripheral" mode="NOTSHARABLE" version="4.0.14" minDaveVersion="4.1.2" instanceLabel="MULTICAN_CONFIG_0" appLabel="">
  ...
  <virtualSignals name="event_node_alert0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_alinp0" hwSignal="alinp" hwResource="//@hwResources.0" required="false" visible="true"/>
  <virtualSignals name="event_node_lec_error0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_lecinp0" hwSignal="lecinp" hwResource="//@hwResources.0" required="false" visible="true"/>
  <virtualSignals name="event_node_transfer_ok0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_trinp0" hwSignal="trinp" hwResource="//@hwResources.0" required="false" visible="true"/>
  <virtualSignals name="event_node_frame_count0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_cfcinp0" hwSignal="cfcinp" hwResource="//@hwResources.0" required="false" visible="true"/>
  ...
  <hwResources name="NODE0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_node0" resourceGroupUri="" required="false" mResGrpUri="peripheral/can/0/node/0"/>
