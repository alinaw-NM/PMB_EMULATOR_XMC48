...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="UART" URI="http://resources/4.1.14/app/UART/0" description="UART APP configures a USIC channel to perform &#xA;transmit &amp; receive operations using UART protocol." mode="NOTSHARABLE" version="4.1.14" minDaveVersion="4.0.0" instanceLabel="UART_0" appLabel="">
  ...
  <hwResources name="NVIC Node Tx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_tx" resourceGroupUri="" required="false" constraintType="NONE" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*"/>
  <hwResources name="NVIC Node Rx" URI="http://resources/4.1.14/app/UART/0/hwres_nvic_node_rx" resourceGroupUri="" required="false" constraintType="NONE" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*"/>
  ...
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_uart_fifo_alt_rx_int/http://resources/4.0.10/app/INTERRUPT/1/vs_nvic_signal_in" sourceSignal="event_fifo_alt_receive" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.11">
  ...
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_uart_fifo_rx_int/http://resources/4.0.10/app/INTERRUPT/1/vs_nvic_signal_in" sourceSignal="event_fifo_std_receive" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.10">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../INTERRUPT/v4_0_10/INTERRUPT_1.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../INTERRUPT/v4_0_10/INTERRUPT_1.app#//@virtualSignals.0"/>
  </connections>
  <connections URI="http://resources/4.1.14/app/UART/0/http://resources/4.1.14/app/UART/0/vs_uart_fifo_tx_int/http://resources/4.0.10/app/INTERRUPT/0/vs_nvic_signal_in" sourceSignal="event_fifo_transmit" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.9">
