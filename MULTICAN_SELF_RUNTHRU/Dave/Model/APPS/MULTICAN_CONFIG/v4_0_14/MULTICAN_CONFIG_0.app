...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="MULTICAN_CONFIG" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0" description="Configures MultiCAN peripheral" mode="NOTSHARABLE" version="4.0.14" minDaveVersion="4.1.2" instanceLabel="MULTICAN_CONFIG_0" appLabel="">
  ...
  <virtualSignals name="rx_pin_node0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_rxd0" hwSignal="rxd" hwResource="//@hwResources.0" required="false" visible="true"/>
  <virtualSignals name="tx_pin_node0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_txd0" hwSignal="txd" hwResource="//@hwResources.0" required="false" visible="true"/>
  ...
  <virtualSignals name="event_node_alert1" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_alinp1" hwSignal="alinp" hwResource="//@hwResources.1" visible="true"/>
  <virtualSignals name="event_node_lec_error1" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_lecinp1" hwSignal="lecinp" hwResource="//@hwResources.1" visible="true"/>
  <virtualSignals name="event_node_transfer_ok1" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_trinp1" hwSignal="trinp" hwResource="//@hwResources.1" visible="true"/>
  <virtualSignals name="event_node_frame_count1" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_cfcinp1" hwSignal="cfcinp" hwResource="//@hwResources.1" visible="true"/>
  <virtualSignals name="event_node_alert2" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_alinp2" hwSignal="alinp" hwResource="//@hwResources.2" visible="true"/>
  <virtualSignals name="event_node_lec_error2" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_lecinp2" hwSignal="lecinp" hwResource="//@hwResources.2" visible="true"/>
  <virtualSignals name="event_node_transfer_ok2" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_trinp2" hwSignal="trinp" hwResource="//@hwResources.2" visible="true"/>
  <virtualSignals name="event_node_frame_count2" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_can_cfcinp2" hwSignal="cfcinp" hwResource="//@hwResources.2" visible="true"/>
  ...
  <virtualSignals name="event_lmo_02_txinp" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message2_txinp" hwSignal="txinp" hwResource="//@hwResources.8" visible="true"/>
  <virtualSignals name="event_lmo_02_rxinp" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message2_rxinp" hwSignal="rxinp" hwResource="//@hwResources.8" visible="true"/>
  <virtualSignals name="event_lmo_03_txinp" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message3_txinp" hwSignal="txinp" hwResource="//@hwResources.9" visible="true"/>
  <virtualSignals name="event_lmo_03_rxinp" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message3_rxinp" hwSignal="rxinp" hwResource="//@hwResources.9" visible="true"/>
  <virtualSignals name="event_lmo_04_txinp" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message4_txinp" hwSignal="txinp" hwResource="//@hwResources.10" visible="true"/>
  <virtualSignals name="event_lmo_04_rxinp" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message4_rxinp" hwSignal="rxinp" hwResource="//@hwResources.10" visible="true"/>
  ...
  <hwResources name="NODE0" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_node0" resourceGroupUri="peripheral/can/0/node/0" mResGrpUri="peripheral/can/0/node/0">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/can/can_0.dd#//@provided.5"/>
  </hwResources>
  <hwResources name="NODE1" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_node1" resourceGroupUri="peripheral/can/0/node/1" mResGrpUri="peripheral/can/0/node/1">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/can/can_0.dd#//@provided.13"/>
  </hwResources>
  <hwResources name="NODE2" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_node2" resourceGroupUri="peripheral/can/0/node/2" mResGrpUri="peripheral/can/0/node/2">
  ...
  <hwResources name="MO_2" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_mobj2" resourceGroupUri="peripheral/can/*/mo/2" mResGrpUri="peripheral/can/*/mo/2">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/can/can_0.dd#//@provided.37"/>
  </hwResources>
  <hwResources name="MO_3" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_mobj3" resourceGroupUri="peripheral/can/*/mo/3" mResGrpUri="peripheral/can/*/mo/3">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/can/can_0.dd#//@provided.33"/>
  </hwResources>
  <hwResources name="MO_4" URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/hwres_can_mobj4" resourceGroupUri="resources/48.0.0/peripheral/can/0/mo/4" mResGrpUri="peripheral/can/*/mo/4">
  ...
  <connections URI="http://resources/4.0.14/app/MULTICAN_CONFIG/0/http://resources/4.0.14/app/MULTICAN_CONFIG/0/vs_message4_rxinp/http://resources/4.0.10/app/INTERRUPT/0/vs_nvic_signal_in" sourceSignal="event_lmo_04_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.45">
